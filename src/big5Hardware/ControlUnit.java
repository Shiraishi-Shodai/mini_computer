...
public class ControlUnit {
    ...
    // 処理の開始
    public void start() {
        System.out.println("1. 制御装置さん：　コンピュータの処理を開始します");
    }
    ...
    public void fetchInput() {
        System.out.println("2. 制御装置さん：　入力装置さんはデータ入力を受け付けてください。受け取ったデータは記憶装置さんに渡してね！");
        ...
        try {
            ...
            this.handleOperationError(errorTiming, "オペランドが整数に変換できません");
    ...
    public void excuteOperation() {
        System.out.println("7. 制御装置さん：　入力装置さんからユーザーさんから受け取ったデータを渡してもらったよね？それを使ってユーザーさんが指定した演算を行って結果を返して");

        try {
            this.passDataToOutputDevice();
            this.arithmeticUnit.calculate(this.memoryUnit);
            this.arithmeticUnit.sendToMemory(this.memoryUnit);
        } catch (Exception e) {
    ...
    public void passDataToArithmeticUnit() {
        System.out.println("8. 制御装置さん：　演算装置さんは記憶装置さんの中に記憶されているデータを使って演算を行ってください。");
    }
    ...
    public void outputResult() {
        this.passDataToOutputDevice();
        System.out.println("13. 制御装置さん：　出力装置さんは演算結果を出力してください。");
        this.outputDevice.displayResult(this.memoryUnit.getResult());
